...
function GetDate(idname,e){
    var sDate;
	var getElement = is_moz ? e.target : event.srcElement;
...
function ShowCalendar(idname){
	...
	table+="</select>";
    table+="</td>";
    table+="<td style='border-bottom:1px solid #0066FF; background-color:#84AACE; font-weight:bold; font-family:Wingdings 2,Wingdings,Webdings; font-size:16px; padding-top:2px; color:#4477FF; cursor:hand' align='center' title='关闭' onClick='javascript:HiddenCalendar()'>S</td>";
    table+="</tr>";
